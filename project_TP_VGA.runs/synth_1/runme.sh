...
HD_PWD='C:/Users/djedi/OneDrive/Desktop/2eme/S2/VHDL/vga_controller/project_TP_VGA/project_TP_VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AMVGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AMVGA.tcl
